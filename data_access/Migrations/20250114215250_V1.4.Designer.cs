...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("domain_layer.EstadoCivil", b =>
                {
            ...
            modelBuilder.Entity("domain_layer.Genero", b =>
                {
            ...
            modelBuilder.Entity("domain_layer.Persona", b =>
                {
                    ...
                    b.Property<string>("persona_movil")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("persona_nombre")
                        .IsRequired()
                        .HasMaxLength(80)
                        .HasColumnType("nvarchar(80)");
            ...
            modelBuilder.Entity("domain_layer.SystemUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("domain_layer.SystemUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("domain_layer.Persona", b =>
                {
                    b.HasOne("domain_layer.EstadoCivil", "EstadoCivil")
                        .WithMany()
                        .HasForeignKey("estado_civil_id");

                    b.HasOne("domain_layer.Genero", "Genero")
                        .WithMany("Personas")
