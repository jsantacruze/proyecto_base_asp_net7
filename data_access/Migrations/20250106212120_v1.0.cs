        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    genero_nombre = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    persona_id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    persona_nombre = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    persona_apellidos = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    persona_email = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
